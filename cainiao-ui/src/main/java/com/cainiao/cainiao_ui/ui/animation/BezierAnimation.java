package com.cainiao.cainiao_ui.ui.animation;

import android.view.View;
import android.view.ViewGroup;
import android.widget.ImageView;

import com.cainiao.cainiao_ui.ui.dimen.ScreenUtils;
import com.ruolan.cainiao_core.delegate.CainiaoDelegate;

public final class BezierAnimation {

    public static void addCart(CainiaoDelegate delegate, View start, View end,
