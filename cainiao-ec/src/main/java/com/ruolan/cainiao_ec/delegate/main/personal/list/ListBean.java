package com.ruolan.cainiao_ec.delegate.main.personal.list;
...
public class ListBean implements MultiItemEntity {
    ...
    public ListBean(int mItemType, String mImageUrl, String mText, String mValue, int mId, CainiaoDelegate mDelegate, CompoundButton.OnCheckedChangeListener mOnCheckedChangeListener) {
    ...
    public static final class Builder {
        ...
        private CainiaoDelegate delegate = null;
        ...
        public Builder setDelegate(CainiaoDelegate delegate) {
